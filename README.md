This project is a **simple calculator** built using **Java Swing**. While the logic was easy, I learned key concepts like **GUI design**, **event handling**, and **component interaction** in Java.  
